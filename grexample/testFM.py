...
# Title: Testfm
# Generated: Sun Aug 12 19:23:39 2018
...
class testFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, audio_device="dmix:CARD=monitor,DEV=0", decimation=1, fm_station=401100000, hostname='127.0.0.1', interpolation=2, uri='193.168.2.1', wav_file='/home/work/github/gnuradio/grexample/111.wav'):
        ...
        self.pluto_source_0 = iio.pluto_source(uri, fm_station, samp_rate, 20000, 0x20000, True, True, True, "manual", 10.0, '', True)
    ...
    def set_fm_station(self, fm_station):
        self.fm_station = fm_station
        self.qtgui_sink_x_1.set_frequency_range(self.fm_station, self.samp_rate)
        self.qtgui_sink_x_0.set_frequency_range(self.fm_station, 20000)
        self.pluto_source_0.set_params(self.fm_station, self.samp_rate, 20000, True, True, True, "manual", 10.0, '', True)
...
def main(top_block_cls=testFM, options=None):
    if options is None:
